    ...
    this.restApiService.getByParameters(PathConstants.HostelGallery_Get, params).subscribe(res => {
      if (res !== null && res !== undefined) {
        if (res.Table.length !== 0) {
          res.Table.forEach(i => {
            i.previewImageSrc = this.logged_user.domainUrl + 'assets/layout/' + this.logged_user.hostelId + '/Events/2021-2022/' + i.Image;
            i.thumbnailImageSrc = this.logged_user.domainUrl + 'assets/layout/' + this.logged_user.hostelId + '/Events/2021-2022/' + i.Image;
